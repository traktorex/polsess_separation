...
def test_external_pairings_overrides_argmax():
    """When external_pairings covers an overlap it wins over the per-overlap
    argmax (a strictly stronger global decision), labelled honestly."""
